...
import { Calendar as CalendarIcon, CheckSquare, Calculator as CalculatorIcon, Sun, Moon, StickyNote, Palette, Timer, HelpCircle } from 'lucide-react'

type Tab = 'calendar' | 'todo' | 'calculator' | 'postit' | 'pomodoro'
...
function App() {
  ...
  const helpContent = {
    ...
    todo: "La Lista de Tareas te ayuda a organizar tus actividades. Agrega nuevas tareas y márcalas como completadas.",
